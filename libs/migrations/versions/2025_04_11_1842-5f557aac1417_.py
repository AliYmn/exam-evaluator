...
Revision ID: 5f557aac1417
Revises:
Create Date: 2025-04-11 18:42:12.289799
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("eating_hours", sa.Integer(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("notes", sa.String(length=9999), nullable=True),
    ...
    op.create_index(op.f("ix_fasting_meal_logs_plan_id"), "fasting_meal_logs", ["plan_id"], unique=False)
    ...
    op.create_index(op.f("ix_fasting_workout_logs_plan_id"), "fasting_workout_logs", ["plan_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_fasting_workout_logs_plan_id"), table_name="fasting_workout_logs")
    op.drop_table("fasting_workout_logs")
    op.drop_index(op.f("ix_fasting_meal_logs_user_id"), table_name="fasting_meal_logs")
    op.drop_index(op.f("ix_fasting_meal_logs_plan_id"), table_name="fasting_meal_logs")
