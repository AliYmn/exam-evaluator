...
from ai_service.api.v1.workout.workout_schemas import WorkoutCreate, WorkoutUpdate, WorkoutListResponse
from ai_service.core.services.workout_service import WorkoutService
