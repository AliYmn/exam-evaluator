...
from ai_service.core.worker.tasks import (
...
class AuthService:
    def __init__(self, db: AsyncSession):
        ...
        self.ai_service = SharedAuthService(db)
    ...
    async def authenticate_user(self, login_data: LoginRequest) -> Token:
        ...
        access_token, refresh_token, expires_in = await self.ai_service.create_token_pair(
            user_id=str(user.id),
    ...
    async def refresh_token(self, refresh_token_data: RefreshToken) -> Token:
        ...
        payload = await self.ai_service.validate_token(refresh_token_data.refresh_token)
    ...
    async def get_current_user(self, token: str) -> UserResponse:
        ...
        payload, user = await self.ai_service.validate_token_with_user(token)
